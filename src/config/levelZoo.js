...
export const ZOO_LEVEL = {
  ...
  objects: [
    ...
    { type: 'platform', x: -13, y: 30, w: 10, h: 0.6 },
    { type: 'platform', x: 0, y: 30, w: 10, h: 0.6 },
    { type: 'platform', x: 13, y: 30, w: 10, h: 0.6 },
    ...
    { type: 'platform', x: 0, y: 24.6, w: 6, h: 0.6 },
    { type: 'arrowPickup', x: -1.2, y: 25.3, amount: 5 },
    { type: 'arrowPickup', x: 1.2, y: 25.3, amount: 5 },
    { type: 'label', x: 0, y: 26.1, text: 'AMMO STATION', w: 4.1, h: 0.8 },

    // ---- Left-side return stairs ----
    { type: 'platform', x: -23, y: 3, w: 2.6, h: 0.45 },
    { type: 'platform', x: -21, y: 6, w: 2.6, h: 0.45 },
    { type: 'platform', x: -19, y: 9, w: 2.6, h: 0.45 },
    { type: 'platform', x: -17, y: 12, w: 2.6, h: 0.45 },
    { type: 'platform', x: -15, y: 15, w: 2.6, h: 0.45 },
    { type: 'platform', x: -13, y: 18, w: 2.6, h: 0.45 },
    { type: 'platform', x: -11, y: 21, w: 2.6, h: 0.45 },
    { type: 'platform', x: -9, y: 24, w: 2.6, h: 0.45 },
    { type: 'platform', x: -7, y: 27, w: 2.6, h: 0.45 },
    ...
    // ---- Walker bay ----
    { type: 'platform', x: -19, y: 2.0, w: 7.2, h: 0.6 },
    { type: 'platform', x: -21, y: 5.1, w: 3.1, h: 0.5 },
    { type: 'platform', x: -17, y: 6.8, w: 3.1, h: 0.5 },
    { type: 'walker', x: -19, y: 3.0, dir: 1 },
    { type: 'label', x: -19, y: 9.2, text: 'WALKER: dash-kill reset test', w: 6.9, h: 0.86 },

    // ---- Archer bay ----
    { type: 'platform', x: -9.5, y: 2.0, w: 6.6, h: 0.6 },
    { type: 'platform', x: -7.4, y: 5.4, w: 3.0, h: 0.5 },
    { type: 'platform', x: -11.4, y: 5.1, w: 2.8, h: 0.5 },
    { type: 'archer', x: -7.4, y: 6.4, dir: -1 },
    { type: 'label', x: -9.5, y: 9.2, text: 'ARCHER: projectile pressure', w: 6.2, h: 0.86 },

    // ---- Flyer bay ----
    { type: 'platform', x: 0, y: 2.0, w: 6.6, h: 0.6 },
    { type: 'platform', x: -1.9, y: 5.1, w: 2.8, h: 0.5 },
    { type: 'platform', x: 2.0, y: 6.6, w: 2.8, h: 0.5 },
    { type: 'flyer', x: 0, y: 4.3, range: 2.0 },
    { type: 'label', x: 0, y: 9.2, text: 'FLYER: aerial patrol + spacing', w: 6.4, h: 0.86 },

    // ---- Spike bay ----
    { type: 'platform', x: 9.5, y: 2.0, w: 6.6, h: 0.6 },
    { type: 'platform', x: 8.0, y: 5.0, w: 2.8, h: 0.5 },
    { type: 'platform', x: 11.2, y: 6.7, w: 2.8, h: 0.5 },
    ...
    { type: 'platform', x: 19, y: 9.3, w: 4.0, h: 0.5 },
    { type: 'walker', x: 19, y: 3.0, dir: -1 },
