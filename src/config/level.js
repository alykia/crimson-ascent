...
export const LEVEL = {
  ...
  objects: [
    ...
    // =============================================================
    { type: 'platform', x: -4, y: 2.0, w: 3, h: 0.5 },
    { type: 'platform', x:  3, y: 4.0, w: 3, h: 0.5 },
    { type: 'platform', x: -3, y: 6.0, w: 3, h: 0.5 },
    { type: 'platform', x:  3, y: 8.0, w: 3, h: 0.5 },
    ...
    // =============================================================
    { type: 'platform', x: 3, y: 10.0, w: 4, h: 0.5 },
    ...
    { type: 'platform', x: 4.2, y: 14.1, w: 1.5, h: 0.5 },
    ...
    // =============================================================
    { type: 'platform', x: 0, y: 16.5, w: 3, h: 0.5 },
    { type: 'walker',   x: 0, y: 17.5, dir: 1 },
    // Wide gap → dash to clear
    { type: 'platform', x:  8, y: 17.5, w: 2.5, h: 0.5 },
    // Side assists: optional bailout ledges that smooth failed lines without
    // trivializing the climb.
    { type: 'platform', x: -7.2, y: 18.0, w: 2.0, h: 0.5 },
    { type: 'platform', x:  6.8, y: 20.0, w: 2.0, h: 0.5 },
    // Step up
    { type: 'platform', x: -3, y: 19.5, w: 3,   h: 0.5 },
    { type: 'platform', x:  3, y: 21.5, w: 4,   h: 0.5 },
    ...
    // =============================================================
    { type: 'platform', x: 3, y: 23.5, w: 5, h: 0.5 },
    { type: 'arrowPickup', x: 2, y: 24.5, amount: 3 },
    // Archer perch
    { type: 'platform', x:  6, y: 25.5, w: 2.5, h: 0.5 },
    { type: 'archer',   x:  6, y: 26.5, dir: -1 },
    // Flyer blocks the route up
    { type: 'flyer',    x: -1, y: 27.5, range: 3 },
    // Continued climb on the left
    { type: 'platform', x: -4, y: 26.5, w: 3, h: 0.5 },
    { type: 'platform', x: -2, y: 28.5, w: 3, h: 0.5 },
    { type: 'platform', x:  3, y: 30.0, w: 4, h: 0.5 },
    ...
    { type: 'platform', x: 0, y: 39.5, w: 4, h: 0.5 },
