...
// the ranking tabs.
export const CHALLENGE_TYPES = Object.freeze(['level1', 'level2', 'all']);
...
// Which level config each challenge type starts on. Level 1 and All begin on
